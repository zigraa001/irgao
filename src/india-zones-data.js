...
const INDIA_ZONES = [
  ...
  // ═══════════════════════════════════════════════════════════════════════
  { name: "Delhi IGI — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(77.1, 28.556) },
  { name: "Mumbai CSIA — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(72.868, 19.089) },
  { name: "Bengaluru KIAL — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(77.706, 13.199) },
  { name: "Chennai — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(80.169, 12.994) },
  { name: "Kolkata — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(88.446, 22.654) },
  { name: "Hyderabad RGIA — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(78.429, 17.24) },
  { name: "Kochi — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(76.392, 10.152) },
  { name: "Ahmedabad — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(72.635, 23.077) },
  { name: "Pune — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(73.91, 18.582) },
  { name: "Goa — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(73.832, 15.38) },
  { name: "Jaipur — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(75.806, 26.824) },
  { name: "Lucknow — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(80.889, 26.76) },
  { name: "Chandigarh — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(76.788, 30.674) },
  { name: "Srinagar — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(74.774, 33.987) },
  { name: "Guwahati — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(91.588, 26.106) },
  { name: "Bhubaneswar — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(85.818, 20.244) },
  { name: "Coimbatore — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(77.043, 11.03) },
  { name: "Nagpur — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(79.055, 21.092) },
  { name: "Varanasi — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(82.859, 25.452) },
  { name: "Amritsar — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(74.797, 31.71) },
  { name: "Thiruvananthapuram — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(76.92, 8.482) },
  { name: "Patna — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(85.089, 25.591) },
  { name: "Ranchi — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(85.321, 23.314) },
  { name: "Indore — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(75.801, 22.72) },
  { name: "Visakhapatnam — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(83.224, 17.721) },
  { name: "Solapur Airport — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "airport", geometry: airportZone(75.934, 17.628) },

  // ═══════════════════════════════════════════════════════════════════════
  // NO-FLY: Military Air Force Bases
  // Active runways — absolute no-fly at all altitudes.
  // ═══════════════════════════════════════════════════════════════════════
  { name: "Hindon AFB — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "military_airbase", geometry: airportZone(77.364, 28.708, 0.04) },
  { name: "Tambaram AFB (Chennai) — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "military_airbase", geometry: airportZone(80.124, 12.908, 0.03) },
  { name: "Yelahanka AFB (Bengaluru) — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "military_airbase", geometry: airportZone(77.606, 13.136, 0.03) },
  { name: "Lohegaon AFB (Pune) — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "military_airbase", geometry: airportZone(73.921, 18.583, 0.03) },
  { name: "Jodhpur AFB — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "military_airbase", geometry: airportZone(73.049, 26.251, 0.04) },
  { name: "Jamnagar AFB — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "military_airbase", geometry: airportZone(70.012, 22.465, 0.03) },
  { name: "Agra AFB — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "military_airbase", geometry: airportZone(77.961, 27.157, 0.03) },
  { name: "Halwara AFB (Punjab) — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "military_airbase", geometry: airportZone(75.764, 30.744, 0.03) },
  { name: "Pathankot AFB — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "military_airbase", geometry: airportZone(75.634, 32.234, 0.03) },
  { name: "INS Hansa (Goa Naval Air) — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 914, category: "military_airbase", geometry: airportZone(73.839, 15.392, 0.025) },

  // ═══════════════════════════════════════════════════════════════════════
  // NO-FLY: Nuclear Facilities
  // AERB (Atomic Energy Regulatory Board) mandated exclusion zones.
  // ═══════════════════════════════════════════════════════════════════════
  { name: "BARC Trombay — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 1500, category: "nuclear", geometry: circleZone(72.925, 19.012, 0.025) },
  { name: "Tarapur Nuclear Plant — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 1500, category: "nuclear", geometry: circleZone(72.668, 19.831, 0.03) },
  { name: "Kalpakkam Nuclear Plant — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 1500, category: "nuclear", geometry: circleZone(80.176, 12.564, 0.03) },
  { name: "Kakrapar Nuclear Plant — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 1500, category: "nuclear", geometry: circleZone(73.35, 21.236, 0.03) },
  { name: "Rawatbhata Nuclear Plant — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 1500, category: "nuclear", geometry: circleZone(75.585, 24.881, 0.03) },
  { name: "Kudankulam Nuclear Plant — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 1500, category: "nuclear", geometry: circleZone(77.733, 8.168, 0.03) },
  { name: "Narora Nuclear Plant — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 1500, category: "nuclear", geometry: circleZone(78.399, 28.517, 0.025) },
  { name: "Kaiga Nuclear Plant — no-fly", zoneType: "no_fly", minAltitudeM: 0, maxAltitudeM: 1500, category: "nuclear", geometry: circleZone(74.434, 14.854, 0.03) },
