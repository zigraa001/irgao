...
async function initSchema() {
  ...
  const droneServices = [
    ...
    { name: "Campus Drone Delivery", category: "campus", emoji: "🏫",
      desc: "Campus drone delivery. ₹49 to launch, then ₹7 per kilometre, plus GST. Meals and light parcels between campus pads.",
      specs: "₹49 base · ₹7/km · 2kg payload · GPS tracking · Auto-land",
      price: 49, opRequired: 0, opPrice: 0, min: 1, max: 1 },
